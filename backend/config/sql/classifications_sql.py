"""SQL-CASE-Ausdruecke zur Klassifikation (Vegetation, Klima, Hoehe, ...).

Diese Bausteine werden in den Read-Abfragen wiederverwendet, damit die
Datenbank-Ausgabe konsistent zur Karten-/Legenden-Darstellung bleibt.
"""
