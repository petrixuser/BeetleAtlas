-- ============================================================================
--  Schema: Core-Daten (GBIF-Import)
--    beetle_species, location, observation, media, climate_snapshot,
--    quality_report_history
--  Rolle beim DB-Aufbau: Grundgeruest (Schema-Schritt 1). Legt die Datenbank
--  an und muss ZUERST laufen, bevor Auth-, Read-Model- oder Seed-Skripte folgen.
--  Idempotent/mehrfach ausfuehrbar: nutzt CREATE DATABASE/TABLE IF NOT EXISTS.
-- ============================================================================
