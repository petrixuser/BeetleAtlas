...
CASE
    WHEN b.coordinate_uncertainty IS NULL OR TRIM(b.coordinate_uncertainty) = '' THEN 'unbekannt'
...
CASE
    WHEN b.event_date IS NULL OR TRIM(b.event_date) = '' THEN 'fehlend'
...
CASE
    WHEN b.basis_of_record IS NULL OR TRIM(b.basis_of_record) = '' THEN 'unbekannt'
...
CASE
    WHEN b.license_sample IS NULL OR TRIM(b.license_sample) = '' THEN 'fehlend'
